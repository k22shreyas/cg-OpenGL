...
void background()
{
    ...
    glVertex3f(-1200.0,120.0,0.0);
    glVertex3f(2480.0,120.0,0.0);
    glVertex3f(2480.0,160.0,10.0);
    glVertex3f(-1200.0,160.0,10.0);
    
    glEnd();
glBegin(GL_TRIANGLES);

	glColor3f(0.07f, 0.07f, 0.0f);//brown side
	glVertex3i(-1000,15,450);
	glVertex3i(400,15,450);
	glVertex3i(300,350,10);
	
	glColor3f(0.5,0.5,0.5);//grey side
	glVertex3i(400,15,450);
	glVertex3i(500,15,450);
	glVertex3i(300,350,10);
	
	glColor3f(0.07f, 0.07f, 0.0f);//brown side
	glVertex3i(-2100,15,450);//bottom a
	glVertex3i(-600,15,450);//bottom b
	glVertex3i(10,300,10);
	
	glColor3f(0.5,0.5,0.5);//grey side
	glVertex3i(-600,15,450);
	glVertex3i(-500,15,450);
	glVertex3i(10,300,10);
	
	glColor3f(0.07f, 0.07f, 0.0f);//brown side
	glVertex3i(1400,15,450);//bottom a
	glVertex3i(3000,15,450);//bottom b
	glVertex3i(1200,360,10);
	
	glColor3f(0.5,0.5,0.5);//grey side
	glVertex3i(3000,15,450);
	glVertex3i(3400,15,450);
	glVertex3i(1200,360,10);
	glEnd();
...
void WelcomeDisplay(){
	...
	glColor3f(0,0,0);
    glRasterPos2f(500, 300); //define position on the screen
    char *string = "AMC Education"; 
    while(*string){
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, *string++);
    }
    glRasterPos2f(500, 270);
    char *string2 = "1: Harshat HR"; 
    while(*string2){
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, *string2++);
    }
    glRasterPos2f(500, 240);
    char *string3 = "2: K Shreyas"; 
    while(*string3){
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, *string3++);
    }
    glColor3f(0,0,1);
    glRasterPos2f(500, 140);
    char *string4 = "Press x to start"; 
    while(*string4){
